...
contract ShinobiERC721A is Ownable, ERC721A, ReentrancyGuard, PaymentSplitter {
    ...
    uint private constant MAX_WHITELIST = 520;
    uint private constant MAX_PUBLIC = 450;
    ...
    function privateSaleMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
